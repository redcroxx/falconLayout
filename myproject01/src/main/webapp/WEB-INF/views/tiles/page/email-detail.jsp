...
<div class="card">
  ...
  <div class="card-body bg-light">
    <div class="row justify-content-center">
      <div class="col-lg-8 col-xxl-6">
        <div class="card shadow-none mb-3"><img class="card-img-top" src="/resources/Falcon/img/assets/img/icons/spot-illustrations/international-women-s-day-2.png" alt="" />
          <div class="card-body">
  ...
  <div class="card-footer">
    <div class="row justify-content-between">
      <div class="col"><a class="btn btn-falcon-default btn-sm" href="../../app/email/compose.html"><span class="fas fa-reply" data-fa-transform="down-2"></span><span class="d-none d-sm-inline-block ms-1">Reply</span></a><a class="btn btn-falcon-default btn-sm ms-2" href="../../app/email/compose.html"><span class="fas fa-location-arrow" data-fa-transform="down-2"></span><span class="d-none d-sm-inline-block ms-1">Forward</span></a></div>
