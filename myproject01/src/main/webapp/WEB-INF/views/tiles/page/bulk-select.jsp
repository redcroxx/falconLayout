...
<div class="card mb-3">
  ...
  <div class="card-body position-relative">
    <div class="row">
      <div class="col-lg-8">
        <h3>Bulk Select</h3>
        <p class="mb-0">Bulk select allows users to check multiple checkboxes at once and toggles a UI for bulk actions to be performed for the selected items.</p>
      </div>
    </div>
  </div>
</div>
<div class="card mb-3">
  <div class="card-body">
    ...
    <ul class="mt-2 mb-0">
      ...
      <li>Three(3) elements can be hooked with bulk select: <code>body</code>, <code>actions</code>, <code>replacedElement</code>.
        <pre class="scrollbar mt-2"><code class="language-html">&lt;input class=&quot;form-check-input&quot; type=&quot;checkbox&quot; data-bulk-select='{&quot;body&quot;:&quot;bulk-select-body&quot;,&quot;actions&quot;:&quot;bulk-select-actions&quot;,&quot;replacedElement&quot;:&quot;bulk-select-replace-element&quot;}' /&gt;</code></pre>
        <p class="mb-0">These ids definded in these keys are used to hook the respective elements.</p>
      </li>
      <li><code>body:</code> The target checkboxes are wrapped using a unique id defined in <code>body</code>. In this example <code>bulk-select-body</code>. Every targeted checkbox within this wrapper is marked with the attribute <code>data-bulk-select-row.</code></li>
...
<div class="card">
    ...
    <div class="row flex-between-end">
      ...
      <div class="col-auto ms-auto">
        <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
          <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-6328d6a8-8307-4184-8755-9608afce99c6" type="button" role="tab" aria-controls="dom-6328d6a8-8307-4184-8755-9608afce99c6" aria-selected="true" id="tab-dom-6328d6a8-8307-4184-8755-9608afce99c6">Preview</button>
          <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-d73d4863-ffb8-44c6-90d8-e3d52024c4f0" type="button" role="tab" aria-controls="dom-d73d4863-ffb8-44c6-90d8-e3d52024c4f0" aria-selected="false" id="tab-dom-d73d4863-ffb8-44c6-90d8-e3d52024c4f0">Code</button>
        </div>
      </div>
    </div>
  </div>
  <div class="card-body py-0 border-top">
    <div class="tab-content">
      <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-6328d6a8-8307-4184-8755-9608afce99c6" id="dom-6328d6a8-8307-4184-8755-9608afce99c6">
      ...
      <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-d73d4863-ffb8-44c6-90d8-e3d52024c4f0" id="dom-d73d4863-ffb8-44c6-90d8-e3d52024c4f0">
