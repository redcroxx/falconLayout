          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-a8eb1b3e-3d3e-43cf-88a8-b356c06f62fa" type="button" role="tab" aria-controls="dom-a8eb1b3e-3d3e-43cf-88a8-b356c06f62fa" aria-selected="true" id="tab-dom-a8eb1b3e-3d3e-43cf-88a8-b356c06f62fa">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-9b20e2ad-f1f9-4283-837a-5d635b2def12" type="button" role="tab" aria-controls="dom-9b20e2ad-f1f9-4283-837a-5d635b2def12" aria-selected="false" id="tab-dom-9b20e2ad-f1f9-4283-837a-5d635b2def12">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-a8eb1b3e-3d3e-43cf-88a8-b356c06f62fa" id="dom-a8eb1b3e-3d3e-43cf-88a8-b356c06f62fa"><span class="text-danger" data-feather="bell" style="height: 70px; width: 70px;"></span>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-9b20e2ad-f1f9-4283-837a-5d635b2def12" id="dom-9b20e2ad-f1f9-4283-837a-5d635b2def12">
