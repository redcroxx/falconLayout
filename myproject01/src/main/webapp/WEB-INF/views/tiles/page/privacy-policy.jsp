  ...
  <div class="col-lg-8 pe-lg-2">
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <p class="mb-0 ps-3">These Terms apply from when you sign up for the Service. Clicking the âGet startedâ or âSign up with Googleâ button on the Sign up page means that youâve officially âsignedâ the Terms and a binding contract will come into existence on the basis of the Terms (âAgreementâ). If you sign up for the Service on behalf of a company or other entity, you represent and warrant that you have the authority to accept these Terms on their behalf.</p>
        <hr class="my-4" />
        ...
        <p class="mb-0 ps-3">We may change any of the Terms by posting revised Terms of Use on our Website and sending an email to the last email address you gave us or a message to your account area of the Service (âDashboardâ). Unless you terminate your account within seven (7) days of that email, the new Terms will be effective immediately and apply to any continued or new use of the Service. We may change the Website, the Service, or any features of the Service at any time.</p>
        <hr class="my-4" />
        <h6 class="text-primary">Account and password</h6>
        <p class="mb-0 ps-3">Youâre responsible for keeping your account name and password confidential. Youâre also responsible for any use of your account, whether or not you authorized the use. You must immediately notify us of any unauthorized use of your accounts. Weâre not responsible for any losses due to stolen or hacked passwords. We donât have access to your current password, and for security reasons, we may only reset your password.</p>
      </div>
    </div>
    <div class="card mb-3">
      <div class="card-header bg-light">
      ...
      <div class="card-body">
        ...
        <p class="mb-0 ps-3">We may make certain Services available to you free of charge, up to certain limits as described on the Website (âFree Servicesâ). Usage of the Services in excess of those limits requires a payment. We may terminate your access to the Free Services at any time without prior notice and will have no liability in respect of such termination. Without limiting the scope of clause 15, Free Services are provided without any warranty.</p>
        <hr class="my-4" />
        <h6 class="text-primary">Paid service</h6>
        <ol type="1">
          <li>If you use our Services and cross the limits of the Free Services we provide, the âPaid serviceâ section applies for you</li>
          <li>The âInvoice Paymentâ are the fees payable for your invoice, as specified to you when you use our Service beyond the free usage limit. You shall pay for the Invoice Payment to us for the term of your paid usage.</li>
          <li>You wonât be charged for using our services until your usage crosses the free usage limit. At the end of each month (considering you have used beyond our free usage limit), we will generate an invoice containing your usage information, and the due amount for that month.</li>
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <ol type="1">
          <li>You wonât send Spam! By "spam", we mean the definition provided by Spamhaus;</li>
          <li>You wonât use purchased, rented, or third-party lists of email addresses;</li>
          <li>You wonât violate our <a href="#!">Acceptable use policy</a>, which is part of this Agreement;</li>
        ...
        <ol type="1">
          ...
          <li>ensure that your Amazon Web Services (âAWSâ) account complies with the requirements specified by us on our website from time to time; and</li>
        ...
        <ol type="1">
          ...
          <li>falcon facilitates integration with a number of third party services which you can use in relation to your account or your Contents (âThird Party Serviceâ), although we make no warranty as to any ongoing support for any third party service. We make no representation or commitment and shall have no liability or obligation whatsoever in relation to the content or use of, or correspondence with, any Third Party Service. Any contract entered into and any transaction completed by means of your use of the Service with any Third Party Service is between you and the relevant third party, and not us. We recommend that you refer to the third partyâs website terms and conditions and privacy policy prior to using the relevant Third Party Service.</li>
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <ol type="1">
          ...
          <li>the Service is provided to you on an âas isâ basis.</li>
        </ol>
        <hr class="my-4" />
        ...
        <p class="mb-0 ps-3">We wonât be held liable for any delays or failure in performance of any part of the Service, from any cause beyond our control. This includes, but is not limited to, changes to law or regulations, embargoes, fires, earthquakes, floods, strikes, power blackouts, unusually severe weather conditions, and acts of hackers or third-party internet service providers.</p>
        <hr class="my-4" />
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <p class="mb-0 ps-3">Any of these terms that expressly or by implication is intended to continue or come into force on or after termination of this Agreement shall continue in full force and effect. Without limitation, clauses 14 Indemnity, 15 Our responsibility for loss or damage Suffered by you if you are a business, 16 Our responsibility for loss or damage suffered by you if you are a consumer, 18 Data processing terms, 28 Third party rights,29 If you are a business â governing law and jurisdiction, and 30 Which laws apply to this contract and where you may bring legal proceedings if you are a consumer shall continue in full force and effect notwithstanding the termination of this Agreement.</p>
        <hr class="my-4" />
        ...
        <hr class="my-4" />
        <h6 class="text-primary">If you are a business â Governing Law and Jurisdiction</h6>
        <ol type="1">
        ...
        <table class="table table-striped table-bordered">
          <tbody>
            ...
            <tr>
              ...
              <td>Sending campaigns through the Falcon platform storing email addresses provided through one of our forms or integrations. Storing data on recipient behavior, whether they click, open, unsubscribe, bounce when a campaign is sent. Actioning on the Customerâs behalf any âunsubscribeâ requests from recipients of messages sent using the Service.</td>
            </tr>
            <tr>
