            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mt-2">Free, high quality, open source icon library with over 1,300 icons. Include them anyway you likeâSVGs, SVG sprite, or web fonts.</p><a class="btn btn-link ps-0 btn-sm" href="https://icons.getbootstrap.com/#usage" target="_blank">Bootstrap Icons Documentation<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
