...
<div class="row g-3 mb-3">
  <div class="col-xxl-8">
    ...
    <div class="card">
      <div class="bg-holder bg-card" style="background-image:url(/resources/Falcon/img/assets/img/icons/spot-illustrations/corner-5.png);">
      </div>
      <!--/.bg-holder-->

      <div class="card-body position-relative">
        <div class="row g-2 align-items-sm-center">
          <div class="col-auto"><img src="/resources/Falcon/img/assets/img/icons/connect-circle.png" alt="" height="55" /></div>
          <div class="col">
        ...
        <div class="border-top">
          <table class="table table-sm mb-0">
            <tbody>
              <tr>
                <td class="py-3">
                  <div class="d-flex align-items-center"><img src="/resources/Falcon/img/assets/img/icons/chrome-logo.png" alt="" width="16" />
              ...
              <tr>
                <td class="py-3">
                  <div class="d-flex align-items-center"><img src="/resources/Falcon/img/assets/img/icons/safari-logo.png" alt="" width="16" />
              ...
              <tr>
                <td class="py-3">
                  <div class="d-flex align-items-center"><img src="/resources/Falcon/img/assets/img/icons/firefox-logo.png" alt="" width="16" />
  ...
  <div class="col-md-6 col-xxl-4">
    <div class="card h-100">
      <div class="card-header">
        <div class="d-flex align-items-center"><img class="me-2" src="/resources/Falcon/img/assets/img/icons/signal.png" alt="" height="35" />
      ...
      <div class="card-footer bg-light text-end py-2"><a class="btn btn-link btn-sm px-0 fw-medium" href="#!">More Insights<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
    </div>
  </div>
</div>
<div class="row g-3 mb-3">
          ...
          <div class="table-responsive scrollbar">
            <table class="table fs--1 mb-0 overflow-hidden">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-truncate">Halloween Party Started ð ð»</td>
