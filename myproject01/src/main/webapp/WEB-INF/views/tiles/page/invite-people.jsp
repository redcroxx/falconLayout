...
<div class="card">
  <div class="card-body text-center py-5">
    <div class="row justify-content-center">
      <div class="col-7 col-md-5"><img class="img-fluid" src="/resources/Falcon/img/assets/img/icons/spot-illustrations/41.png" alt="" style="width:58%;" /></div>
    </div>
    ...
    <div class="row justify-content-center">
      <div class="col-11 col-sm-10">
        ...
        <div class="row gx-2 my-4">
          <div class="col-lg-4">
            <button class="btn btn-falcon-default d-block w-100 mb-2 mb-xl-0"><img src="/resources/Falcon/img/assets/img/logos/gmail.png" width="20" alt="" /><span class="fw-medium ms-2">Invite from Gmail</span></button>
          </div>
          <div class="col-lg-4">
