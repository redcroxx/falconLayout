      ...
      <div class="contacts-list scrollbar-overlay">
        <div class="nav nav-tabs border-0 flex-column" role="tablist" aria-orientation="vertical">
            ...
            <div class="d-flex p-3">
              <div class="avatar avatar-xl">
                <div class="rounded-circle overflow-hidden h-100 d-flex">
                  <div class="w-50 border-end"><img src="/resources/Falcon/img/assets/img/team/1.jpg" alt="" /></div>
                  <div class="w-50 d-flex flex-column"><img class="h-50 border-bottom" src="/resources/Falcon/img/assets/img/team/2.jpg" alt="" /><img class="h-50" src="/resources/Falcon/img/assets/img/team/3.jpg" alt="" /></div>
                </div>
              </div>
              <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                <div class="d-flex justify-content-between">
          ...
          <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-2" data-bs-toggle="tab" data-bs-target="#chat-2" aria-controls="chat-2" aria-selected="false">
            ...
            <div class="d-flex p-3">
              ...
              <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                ...
                <div class="min-w-0">
                  <div class="chat-contact-content pe-3">You: ð
                  </div>
                  <div class="position-absolute bottom-0 end-0 hover-hide"><span class="fas fa-check text-success" data-fa-transform="shrink-5 down-4"></span>
                  </div>
                </div>
          ...
          <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-8" data-bs-toggle="tab" data-bs-target="#chat-8" aria-controls="chat-8" aria-selected="false">
            ...
            <div class="d-flex p-3">
              <div class="avatar avatar-xl">
                <img class="rounded-circle" src="/resources/Falcon/img/assets/img/team/12.jpg" alt="" />
          ...
          <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-9" data-bs-toggle="tab" data-bs-target="#chat-9" aria-controls="chat-9" aria-selected="false">
            ...
            <div class="d-flex p-3">
              <div class="avatar avatar-xl">
                <img class="rounded-circle" src="/resources/Falcon/img/assets/img/team/22.jpg" alt="" />
          ...
          <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-10" data-bs-toggle="tab" data-bs-target="#chat-10" aria-controls="chat-10" aria-selected="false">
            ...
            <div class="d-flex p-3">
              <div class="avatar avatar-xl">
                <img class="rounded-circle" src="/resources/Falcon/img/assets/img/team/23.jpg" alt="" />
            ...
            <div class="h-100 overflow-auto scrollbar">
              ...
              <div class="px-3" id="others-info-0">
                ...
                <div class="collapse" id="shared-media-0" aria-labelledby="shared-media-title-0" data-parent="#others-info-0">
                  <div class="row mx-n1">
                    <div class="col-6 col-md-4 px-1"><a href="/resources/Falcon/img/assets/img/chat/1.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="/resources/Falcon/img/assets/img/chat/1.jpg" alt="" /></a></div>
                    <div class="col-6 col-md-4 px-1"><a href="/resources/Falcon/img/assets/img/chat/2.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="/resources/Falcon/img/assets/img/chat/2.jpg" alt="" /></a></div>
                    <div class="col-6 col-md-4 px-1"> <a href="/resources/Falcon/img/assets/img/chat/3.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="/resources/Falcon/img/assets/img/chat/3.jpg" alt="" /></a></div>
                    <div class="col-6 col-md-4 px-1"> <a href="/resources/Falcon/img/assets/img/chat/4.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="/resources/Falcon/img/assets/img/chat/4.jpg" alt="" /></a></div>
                    <div class="col-6 col-md-4 px-1"> <a href="/resources/Falcon/img/assets/img/chat/5.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="/resources/Falcon/img/assets/img/chat/5.jpg" alt="" /></a></div>
                    <div class="col-6 col-md-4 px-1"> <a href="/resources/Falcon/img/assets/img/chat/6.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="/resources/Falcon/img/assets/img/chat/6.jpg" alt="" /></a></div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="w-100 w-xxl-75">
                  <div class="hover-actions-trigger d-flex flex-end-center">
                    ...
                    <div class="bg-primary text-white p-2 rounded-2 chat-message light">
                      ...
                      <a href="/resources/Falcon/img/assets/img/chat/1.jpg" data-gallery="gallery-3">
                        <img class="rounded" src="/resources/Falcon/img/assets/img/chat/1.jpg" alt="" width="150">
                      </a>
                    ...
                    <div class="chat-message chat-gallery">
                      <div class="row mx-n1">
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/7.jpg" data-gallery="gallery-1"><img src="/resources/Falcon/img/assets/img/chat/7.jpg" alt="" class="img-fluid rounded mb-2"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/8.jpg" data-gallery="gallery-1"><img src="/resources/Falcon/img/assets/img/chat/8.jpg" alt="" class="img-fluid rounded mb-2"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/9.jpg" data-gallery="gallery-1"><img src="/resources/Falcon/img/assets/img/chat/9.jpg" alt="" class="img-fluid rounded mb-2"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/10.jpg" data-gallery="gallery-1"><img src="/resources/Falcon/img/assets/img/chat/10.jpg" alt="" class="img-fluid rounded mb-2 mb-lg-0"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/11.jpg" data-gallery="gallery-1"><img src="/resources/Falcon/img/assets/img/chat/11.jpg" alt="" class="img-fluid rounded mb-2 mb-lg-0"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/12.jpg" data-gallery="gallery-1"><img src="/resources/Falcon/img/assets/img/chat/12.jpg" alt="" class="img-fluid rounded"></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="w-xxl-75">
                  <div class="hover-actions-trigger d-flex align-items-center">
                    <div class="chat-message chat-gallery">
                      <div class="row mx-n1">
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/1.jpg" data-gallery="gallery-2"><img src="/resources/Falcon/img/assets/img/chat/1.jpg" alt="" class="img-fluid rounded mb-2"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/2.jpg" data-gallery="gallery-2"><img src="/resources/Falcon/img/assets/img/chat/2.jpg" alt="" class="img-fluid rounded mb-2"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/3.jpg" data-gallery="gallery-2"><img src="/resources/Falcon/img/assets/img/chat/3.jpg" alt="" class="img-fluid rounded mb-2"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/4.jpg" data-gallery="gallery-2"><img src="/resources/Falcon/img/assets/img/chat/4.jpg" alt="" class="img-fluid rounded mb-2 mb-lg-0"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/5.jpg" data-gallery="gallery-2"><img src="/resources/Falcon/img/assets/img/chat/5.jpg" alt="" class="img-fluid rounded mb-2 mb-lg-0"></a>
                        </div>
                        <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                          <a href="/resources/Falcon/img/assets/img/chat/6.jpg" data-gallery="gallery-2"><img src="/resources/Falcon/img/assets/img/chat/6.jpg" alt="" class="img-fluid rounded"></a>
                        </div>
                      </div>
                    </div>
                    <ul class="hover-actions position-relative list-inline mb-0 text-400 ms-2">
          ...
          <div class="chat-content-scroll-area scrollbar">
              ...
              <div class="flex-1 d-flex justify-content-end">
                <div class="w-100 w-xxl-75">
                  <div class="hover-actions-trigger d-flex flex-end-center">
                    ...
                    <div class="bg-primary text-white p-2 rounded-2 chat-message light">Your are right ð
                    </div>
                  </div>
                  <div class="text-400 fs--2 text-end">11:54 am<span class="fas fa-check ms-2 text-success"></span>
                  </div>
            ...
            <div class="d-flex p-3">
              ...
              <div class="flex-1">
                <div class="w-xxl-75">
                  <div class="hover-actions-trigger d-flex align-items-center">
                    <div class="chat-message bg-200 p-2 rounded-2">It will be a great opportunity if I can contribute to this task ð</div>
                    <ul class="hover-actions position-relative list-inline mb-0 text-400 ms-2">
                      <li class="list-inline-item"><a class="chat-option" href="#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Forward"><span class="fas fa-share"></span></a></li>
                      <li class="list-inline-item"><a class="chat-option" href="#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Archive"><span class="fas fa-archive"></span></a></li>
                      <li class="list-inline-item"><a class="chat-option" href="#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="fas fa-edit"></span></a></li>
              ...
              <div class="flex-1 d-flex justify-content-end">
                <div class="w-100 w-xxl-75">
                  <div class="hover-actions-trigger d-flex flex-end-center">
                    ...
                    <div class="bg-primary text-white p-2 rounded-2 chat-message light">ð
                    </div>
                  </div>
                  <div class="text-400 fs--2 text-end">11:54 am<span class="fas fa-check ms-2 text-success"></span>
                  </div>
