            ...
            <div class="col-6">
              <div class="card">
                <div class="card-header">
                  ...
                  <p class="mt-2 mb-0"><strong>Be sure to include text for screen readers</strong>, as we’ve done with <code>aria-label</code>. Disabled close buttons have <code>pointer-events: none </code>and <code>user-select: none</code> applied to, preventing hover and active states from triggering.</p>
                </div>
